...
- If all sub-specs are `Complete`: update `docs/current-feature.md` Status to `Complete`, move the epic entry to the History section, and report the epic as done to the user.
